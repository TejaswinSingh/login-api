...
func (s *authService) loginDecoder(_ http.ResponseWriter, r *http.Request) (loginRequest, error) {
...
func (s *authService) encoder(w http.ResponseWriter, r *http.Request, resp any) {
...
func (s *authService) errorEncoder(w http.ResponseWriter, r *http.Request, err *ErrorWithStatus) {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
